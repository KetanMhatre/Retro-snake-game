...
class GamePanel extends JPanel implements ActionListener {
    static final int SCREEN_WIDTH=600; //panel width
    static final int SCREEN_HEIGHT=600; //panel height
    ...
    static final int DELAY=75; // timer delay
    final int x[]=new int[GAME_UNITS]; // will hold x coordinates of the body part
    final int y[]=new int[GAME_UNITS];// will hold y coordinates of the body part
